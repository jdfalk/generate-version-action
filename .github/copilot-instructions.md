...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to version generation logic should be made in the embedded Python
...
This repository provides a composite GitHub Action that generates semantic
versions based on conventional commits.
