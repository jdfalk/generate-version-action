...
- All changes to version generation logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that generates semantic versions based on conventional commits.
